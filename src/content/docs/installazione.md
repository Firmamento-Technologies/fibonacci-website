...
L'email di invito arriva da un indirizzo di sistema, con oggetto `Invito a Fibonacci`. Contiene un link unico valido per quarantotto ore.

Apri il link in una scheda nuova del browser. Se il link risulta scaduto, chiedi un nuovo invito tramite {EMAIL_SUPPORTO}.
...
**Il link di invito risulta scaduto.** I link sono validi quarantotto ore. Richiedi un nuovo invito tramite {EMAIL_SUPPORTO}, indicando l'email destinataria.
