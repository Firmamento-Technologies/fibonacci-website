...
- **Fatturato e incassi.** La dashboard è clinica, non amministrativa.
- **Nomi di risorse tecniche.** Fino ad agosto 2026 i sottotitoli erano scritti in
  gergo di implementazione; oggi ogni voce è in lingua clinica. Se ne trovi uno che
  non capiresti a voce alta con un collega, segnalalo: è un difetto.

## Se la pagina è vuota

Uno studio appena aperto vede zero ovunque, ed è corretto. La giornata resta vuota
finché non c'è un appuntamento in agenda per oggi: si crea da **Appuntamenti**.
