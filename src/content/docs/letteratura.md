...
La pagina **Letteratura** interroga PubMed dall'interno della cartella, senza aprire
un'altra scheda del browser e senza uscire dal contesto della visita.

## Come si cerca

Si scrivono uno o più termini e si conferma. La ricerca passa da PubMed (NCBI): non
esiste un archivio nostro di articoli, e non conserviamo la cronologia delle ricerche.
...
gli articoli a pagamento il collegamento non c'è: non abbiamo abbonamenti editoriali,
e non li simuliamo.
...
## Un limite che conviene conoscere

La ricerca è **in inglese**, perché PubMed indicizza in inglese. Cercare «acido
ialuronico» dà molto meno di «hyaluronic acid». Non traduciamo automaticamente i
termini: una traduzione sbagliata cambierebbe silenziosamente i risultati, e in
clinica è peggio di nessun risultato.
